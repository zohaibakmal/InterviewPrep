...
public class BinaryTree { 
  ...
  */ 
  ...
  public void printItrPreOrder(Node node){
  ...
  public void printItrInOrder(Node node){
	  Stack <Node> parentStack = new Stack<Node>();
  ...
  public void printItrPostOrder(Node node){
	  Stack <Node> parentStack = new Stack<Node>();
  ...
  public void levelOrder(Node node){
	  Queue <Node> masterQueue = new LinkedList <Node> ();
	  masterQueue.add(node);
	  while (!masterQueue.isEmpty()){
		  node = masterQueue.remove();
		  visit(node);
		  if (node.left != null){
